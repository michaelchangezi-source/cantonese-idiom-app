...
const SUB_DESC = ['配對成語與意思', '填入缺少的字', '選擇正確成語', '聆聽後選出成語'];
const SUB_ICONS = ['🔗', '✏️', '📖', '🔊'];
  ...
  return (
    <div className="max-w-md mx-auto px-4 pb-10">
      <div className="flex items-center gap-3 py-4">
        <button onClick={onBack} className="p-2 rounded-full hover:bg-stone-200 text-stone-500">
          ←
        </button>
        <div>
          <h1 className="text-xl font-bold text-stone-800">關卡 {groupIdx + 1}</h1>
      ...
      <div className="bg-white rounded-xl shadow p-4 mb-6 border border-stone-200">
        <p className="text-xs text-stone-400 mb-2">本關成語 ({group.idioms.length}個)</p>
